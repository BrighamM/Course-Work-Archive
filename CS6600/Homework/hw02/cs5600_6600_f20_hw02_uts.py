...
class cs5600_6600_f20_hw02_uts(unittest.TestCase):
    ...
    #     and_wmats = converge_train_n_layer_nn(X1, y_and, build_231_nn)
    ...
    #     and_wmats = converge_train_n_layer_nn(X1, y_and, build_2331_nn)
    ...
    #     or_wmats = converge_train_n_layer_nn(X1, y_or, build_231_nn)
    ...
    # def test_assgn_02_ut_05(self, thresh=0.4):
    #     or_wmats = converge_train_n_layer_nn(X1, y_or, build_2331_nn)
    #     print('Training & Testing 2x3x3x1 OR ANN Thresholded at {}'.format(thresh))    
    #     for i in range(len(X1)):
    ...
    #     xor_wmats = converge_train_n_layer_nn(X1, y_xor, build_2331_nn)
    ...
    # def test_assgn_02_ut_06(self, thresh=0.4):
    #     xor_wmats = converge_train_n_layer_nn(X1, y_xor, build_231_nn)
    ...
    #     not_wmats = converge_train_n_layer_nn(X2, y_not, build_121_nn)
    ...
    # def test_assgn_02_ut_07(self, thresh=0.4):
    #     not_wmats = converge_train_n_layer_nn(X2, y_not, build_1221_nn)
    ...
    def test_assgn_02_ut_09(self, thresh=0.4):
        bool_wmats = converge_train_n_layer_nn(X3, bool_exp, build_421_nn)
    ...
    #     bool_wmats = converge_train_n_layer_nn(X3, bool_exp, build_4221_nn)
    ...
    # def test_all_the_things(self, thresh=0.4):
    #     print("Testing all the things!")
    #     bool_3layer_wmats_converge = converge_train_n_layer_nn(X1, y_and, build_231_nn)
