...
class Model:
    ...
    def _define_model_3(self):
        ...
        self._fc3 = tf.layers.dense(self._fc2, 100, activation=tf.nn.relu)
    ...
    def _define_model_4(self):
        ...
        self._fc1 = tf.layers.dense(self._states, 25, activation=tf.nn.relu)

        self._fc2 = tf.layers.dense(self._fc1, 25, activation=tf.nn.relu)

        self._fc3 = tf.layers.dense(self._fc2, 25, activation=tf.nn.relu)

        self._fc4 = tf.layers.dense(self._fc3, 25, activation=tf.nn.relu)
    ...
    def _define_model_5(self):
        ...
        self._fc1 = tf.layers.dense(self._states, 12, activation=tf.nn.relu)

        self._fc2 = tf.layers.dense(self._fc1, 12, activation=tf.nn.relu)

        self._fc3 = tf.layers.dense(self._fc2, 12, activation=tf.nn.relu)

        self._fc4 = tf.layers.dense(self._fc3, 12, activation=tf.nn.relu)

        self._fc5 = tf.layers.dense(self._fc4, 12, activation=tf.nn.relu)
