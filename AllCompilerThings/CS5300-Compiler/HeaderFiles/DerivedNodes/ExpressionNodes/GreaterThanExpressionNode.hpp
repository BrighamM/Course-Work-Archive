#ifndef GREATER_THAN_EXPRESSION_NODE_HPP
#define GREATER_THAN_EXPRESSION_NODE_HPP

#include "ExpressionNode.hpp"

// Expression GREATER_THAN_TOKEN Expression {$$ = new
// ASTNamespace::GreaterThanExpressionNode($1,$3);}
namespace ASTNamespace
{
class GreaterThanExpressionNode : public ExpressionNode
{
    ExpressionNode* leftExpression;
    ExpressionNode* rightExpression;

  public:
    GreaterThanExpressionNode(ExpressionNode* inputLhs, ExpressionNode* inputRhs)
    ...
    virtual bool getBoolValue() const
    {
        ...
        {
            std::cout << "ERROR WITH TYPES GreaterThanExpressionNode" << std::endl;
            return false;
        }
