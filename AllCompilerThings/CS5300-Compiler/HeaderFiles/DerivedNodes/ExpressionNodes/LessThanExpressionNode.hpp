#ifndef LESS_THAN_EXPRESSION_NODE_HPP
#define LESS_THAN_EXPRESSION_NODE_HPP
...
{
class LessThanExpressionNode : public ExpressionNode
{
    ExpressionNode* leftExpression;
    ExpressionNode* rightExpression;

  public:
    LessThanExpressionNode(ExpressionNode* inputLhs, ExpressionNode* inputRhs)
    ...
    virtual PsuedoRegister getTheeIntoRegister() const
    {
        ...
        std::cout << "slt " << lhsRegister.getRegisterName() << " " << lhsRegister.getRegisterName()
    ...
    virtual bool getBoolValue() const
    {
        ...
        {
            std::cout << "ERROR WITH TYPES LessThanExpressionNode" << std::endl;
            return false;
        }
