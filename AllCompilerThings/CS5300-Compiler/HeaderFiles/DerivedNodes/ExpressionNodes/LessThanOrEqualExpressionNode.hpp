#ifndef LESS_THAN_OR_EQUAL_EXPRESSION_NODE_HPP
#define LESS_THAN_OR_EQUAL_EXPRESSION_NODE_HPP

#include "ExpressionNode.hpp"

// Expression LESS_THAN_OR_EQUAL_TOKEN Expression {$$ = new
// ASTNamespace::LessThanOrEqualExpressionNode($1,$3);}
namespace ASTNamespace
{
class LessThanOrEqualExpressionNode : public ExpressionNode
{
    ExpressionNode* leftExpression;
    ExpressionNode* rightExpression;

  public:
    LessThanOrEqualExpressionNode(ExpressionNode* inputLhs, ExpressionNode* inputRhs)
    ...
    virtual PsuedoRegister getTheeIntoRegister() const
    {
        ...
        std::cout << "sle " << lhsRegister.getRegisterName() << " " << lhsRegister.getRegisterName()
    ...
    virtual bool getBoolValue() const
    {
        ...
        {
            std::cout << "ERROR WITH TYPES LessThanOrEqualExpressionNode" << std::endl;
            return false;
        }
