...
namespace ParticleLab
{
	...
	public class MagicNumbersAbound : Microsoft.Xna.Framework.Game
	{
		...
		private MyInstancedModel m_InstancedModel;
		...
		protected override void LoadContent()
		{
			...
			m_InstancedModel = new MyInstancedModel(graphics.GraphicsDevice,Content.Load<Model>(@"Models\Asteroid1"));
			...
			m_InstanceTransforms = new Matrix[COUNT_PARTICLES];
			m_InstanceRotations = new Matrix[COUNT_PARTICLES];
		}
		...
		Matrix[] m_InstanceTransforms;
		Matrix[] m_InstanceRotations;
		...
		protected override void Draw(GameTime gameTime)
		{
			...
			//
			// Prepare the instance transformation matrices into a single array
			for (int Particle = 0; Particle < this.Particles1.Count; Particle++)
			{
				m_InstanceRotations[Particle] =
			...
			m_InstancedModel.Draw(
				...
				m_fxParticles[(int)m_CurrentEffect],
